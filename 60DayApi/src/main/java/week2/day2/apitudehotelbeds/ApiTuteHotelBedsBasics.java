...
public class ApiTuteHotelBedsBasics {
	...
	ArrayList<Object> rateKeyList = new ArrayList<Object>();
	JsonPath jsonresp ;
	
public ArrayList<Object> getRateKeyList() {
		return rateKeyList;
	}

	public void setRateKeyList(ArrayList<Object> rateKeyList) {
		this.rateKeyList = rateKeyList;
	}
